...
# "formula" is the name of a failure indexing technique, e.g., "ReClues", "MSeer", etc.
# "k" is the actual number of faults.
...
def kmedoidsCluster(failed, formula, k):
    ...
    read_distanceDict = {}
    distance_list = []
    # The distance information produced by the "Distance metric" component of ReClues
    table = xlrd.open_workbook('ReClues_Dis/' + formula + '.csv').sheets()[0]
    row = table.nrows
